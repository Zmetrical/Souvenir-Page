...
export const CHARMS = [
  // Hearts
  {id:'c1', name:'Heart Blush',   shape:'heart',     color:'#F9B8CF',            price:15, stock:'in',  category:'charms'},
  {id:'c2', name:'Heart Red',     shape:'heart',     color:'#FF8FAD',            price:15, stock:'in',  category:'charms'},
  {id:'c3', name:'Heart Lavender',shape:'heart',     color:'#C9A9F0',            price:15, stock:'in',  category:'charms'},

  // Stars
  {id:'c4', name:'Star Gold',     shape:'star',      color:'#FFD780',            price:15, stock:'in',  category:'charms'},
  {id:'c5', name:'Star Pink',     shape:'star',      color:'#F9B8CF',            price:15, stock:'in',  category:'charms'},
  {id:'c6', name:'Star Mint',     shape:'star',      color:'#90DDD9',            price:15, stock:'in',  category:'charms'},

  // Moons
  {id:'c7', name:'Moon Butter',   shape:'moon',      color:'#FFE07A',            price:15, stock:'in',  category:'charms'},
  {id:'c8', name:'Moon Lavender', shape:'moon',      color:'#C9A9F0',            price:15, stock:'in',  category:'charms'},

  // Flowers
  {id:'c9', name:'Flower Pink',   shape:'flower',    color:'#F9B8CF', detail:'#FFE07A', price:18, stock:'in',  category:'charms'},
  {id:'c10',name:'Flower Mint',   shape:'flower',    color:'#90DDD9', detail:'#F9B8CF', price:18, stock:'in',  category:'charms'},
  {id:'c11',name:'Flower Lilac',  shape:'flower',    color:'#C9A9F0', detail:'#FFD780', price:18, stock:'in',  category:'charms'},
